import user_image from './profile.jpeg';
...
import fullstack from './fullsatck.png';
...
import github from './git copy.png';
...
export const serviceData = [
    { icon: assets.fullstack, title: 'Full-Stack Web Development', description: 'Building complete web applications using the MERN stack with scalable architecture and secure APIs.', link: '' },
    { icon: assets.frontend, title: 'Frontend Development', description: 'Creating dynamic and responsive interfaces using React.js and Next.js for seamless user experiences.', link: '' },
    { icon: assets.backend, title: 'Backend Development', description: 'Developing RESTful APIs and server-side applications with Node.js, Express, and MongoDB.', link: '' },
    { icon: assets.cloud, title: 'Cloud Deployment & CI/CD', description: 'Automating and deploying applications using AWS, Azure, Jenkins, and Docker for streamlined delivery.', link: '' }
];
...
export const infoList = [ 
    { 
        ...
        title: 'Tech Stack', 
        description: 'Proficient in Node.js, React, TypeScript, MongoDB, AWS, Microservices, Docker, Kubernetes' 
    }, 
    { 
        icon: assets.edu_icon, 
        iconDark: assets.edu_icon_dark, 
        title: 'Education', 
        description: 'B.Tech in Computer Science from Parul University, Vadodara' 
    }, 
    { 
        icon: assets.project_icon, 
        iconDark: assets.project_icon_dark, 
        title: 'Key Projects', 
        description: 'Developed full-stack applications including a food delivery,House Rental,E-commerce Platform and Event Management System' 
    } 
];


export const toolsData = [
    assets.vscode, assets.firebase, assets.mongodb, assets.figma, assets.github,assets.aws,assets.docker,assets.postman
];